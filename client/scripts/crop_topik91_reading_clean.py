...
READING_DIR = ROOT / "public" / "topik_exams" / "ky_91" / "reading"
CLEAN_DIR = ROOT / "public" / "topik_exams" / "ky_91" / "clean" / "reading"
REVIEW_DIR = ROOT / "scripts" / "crop_review" / "topik91_reading_clean"
MAP_PATH = ROOT / "scripts" / "topik91_reading_clean_map.json"
...
QUESTION_CROPS: tuple[QuestionCrop, ...] = (
    QuestionCrop(1, (p(5, 400, 820),)),
    QuestionCrop(2, (p(5, 830, 1200),)),
    QuestionCrop(3, (p(5, 1210, 1640),)),
    QuestionCrop(4, (p(5, 1650, 2150),)),
    QuestionCrop(5, (p(6, 300, 820),)),
    QuestionCrop(6, (p(6, 830, 1320),)),
    QuestionCrop(7, (p(6, 1310, 1820),)),
    QuestionCrop(8, (p(6, 1820, 2280),)),
    QuestionCrop(9, (p(7, 300, 930),)),
    QuestionCrop(10, (p(7, 1260, 2000),)),
    ...
    QuestionCrop(16, (p(10, 300, 670),)),
    QuestionCrop(17, (p(10, 930, 1265),)),
    QuestionCrop(18, (p(10, 1540, 1925),)),
    QuestionCrop(19, (p(11, 300, 785), p(11, 830, 890))),
    QuestionCrop(20, (p(11, 300, 785), p(11, 1130, 1190))),
    QuestionCrop(21, (p(12, 300, 795), p(12, 815, 930))),
    QuestionCrop(22, (p(12, 300, 795), p(12, 1300, 1390))),
    QuestionCrop(23, (p(13, 300, 1175), p(13, 1220, 1310))),
    QuestionCrop(24, (p(13, 300, 1175), p(13, 1720, 1790))),
    QuestionCrop(25, (p(14, 300, 880),)),
    QuestionCrop(26, (p(14, 900, 1400),)),
    QuestionCrop(27, (p(14, 1420, 1950),)),
    QuestionCrop(28, (p(15, 300, 740),)),
    QuestionCrop(29, (p(15, 1110, 1590),)),
    QuestionCrop(30, (p(16, 300, 740),)),
    QuestionCrop(31, (p(16, 1110, 1590),)),
    QuestionCrop(32, (p(17, 300, 805),)),
    QuestionCrop(33, (p(17, 1170, 1660),)),
    QuestionCrop(34, (p(18, 300, 805),)),
    QuestionCrop(35, (p(18, 1210, 1800),)),
    QuestionCrop(36, (p(19, 260, 725),)),
    QuestionCrop(37, (p(19, 1095, 1580),)),
    ...
    QuestionCrop(46, (p(24, 300, 1045),)),
    QuestionCrop(47, (p(24, 300, 1045),)),
    QuestionCrop(48, (p(25, 300, 1235),)),
    QuestionCrop(49, (p(25, 300, 1235),)),
    QuestionCrop(50, (p(25, 300, 1235),)),
)
...
def main() -> None:
    ...
    mapping = {
        "session": 91,
        "section": "reading",
        "source": "client/public/topik_exams/ky_91/reading/page_XX.jpg",
        "outputDir": "/topik_exams/ky_91/clean/reading",
        "questions": {},
    }
    ...
    for question in QUESTION_CROPS:
        ...
        mapping["questions"][str(question.number)] = {
            "image": f"/topik_exams/ky_91/clean/reading/{output_name}",
