...
PROGRESS_PATH = os.path.join(ROOT, "scripts", "ingestion_progress_96.json")
READING_MAP_PATH = os.path.join(ROOT, "scripts", "topik96_reading_clean_map.json")
LISTENING_MAP_PATH = os.path.join(ROOT, "scripts", "topik96_listening_clean_map.json")
...
def main():
    parser = argparse.ArgumentParser(description="Sync TOPIK 96 reading & listening DB image paths to clean crops.")
