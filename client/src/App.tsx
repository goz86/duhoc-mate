        ...
        <div className={`w-full flex-1 flex flex-col lg:h-full lg:max-h-full lg:overflow-hidden ${view !== 'room' ? 'pointer-events-none absolute -left-[9999px] -top-[9999px] h-1 w-1 overflow-hidden opacity-0' : ''} ${
          ...
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-0 lg:overflow-hidden lg:max-h-[calc(100vh-108px)] xl:max-h-[calc(100vh-96px)]">
            ...
            <main className={`${mainSpan} p-2 sm:p-4 xl:p-6 flex flex-col gap-4 lg:overflow-y-auto transition-all duration-300`}>
              ...
              <div className={`${roomCollapsed ? 'flex-1 min-h-[520px] flex items-center justify-center p-5' : 'flex-1 glass-panel rounded-3xl p-2.5 sm:p-4 xl:p-5 shadow-xl border border-white min-h-[360px] xl:min-h-[420px] flex flex-col'} relative ${(stageMode === 'pdf' || stageMode === 'topik') ? 'overflow-visible' : 'overflow-hidden'}`}>
